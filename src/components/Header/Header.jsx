...
const navigation = [
  ...
  },
  {
    ...
    href: "#",
    submenu: [
      { name: "Fan Coil Unit (FCU)", href: "#" },
      { name: "Air cooled Chillers", href: "#" },
      { name: "Packaged Unit/Ductable Split", href: "#" },
      { name: "Air Handling Unit (AHU)", href: "#" },
      { name: "Fan Filter Unit (FFU)", href: "#" },
      { name: "Cold Room", href: "#" },
      { name: "Adiabatic Cooler/Cooling Tower", href: "#" },
      { name: "Renewables", href: "#" },
      { name: "EV Chargers & Battery Storage", href: "#" },
      { name: "UPS/Inverter", href: "#" },
      { name: "Mobility - HVAC", href: "#" },

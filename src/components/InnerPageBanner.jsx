                ...
                {button1 && (
                  link1.endsWith(".pdf") ? (
                    <a
                      ...
                      className="bg-[#1FA54D] hover:bg-white text-white py-3 md:py-4 px-3 text-[15px] md:text-base md:px-4 md:w-52 justify-center rounded-full flex items-center gap-2 md:gap-4 hover:text-[#1FA54D] transition-all duration-400"
                    >
